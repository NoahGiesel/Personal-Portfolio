...
// PARTICLES
particlesJS.load('particles-js', './particles.json', function () {}); // color properties of particles depending on HTML theme [dark || light]

function changeParticlesColor() {
  var currentTheme = document.documentElement.getAttribute('data-theme');
  fetch("./particles.json").then(function (res) {
    return res.json();
  }).then(function (data) {
    var s = JSON.stringify(data.particles.color.value = "red");
  });
} //theme changer
...
var navSlide = function navSlide() {
  ...
  var label = document.querySelector('.sitchTheme');
